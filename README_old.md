...
Once you have your github, as first thing fork this repository, i.e. go [there](https://github.com/PhysicsOfData/LaboratoryOfComputationalPhysics_Y4) and click on the top-right button *fork*
...
`git clone https://github.com/YOUR_GIT_ACCOUNT/LaboratoryOfComputationalPhysics_Y4.git`
...
`git remote set-url origin https://YOUR_GIT_ACCOUNT@github.com/YOUR_GIT_ACCOUNT/LaboratoryOfComputationalPhysics_Y4.git`
